let preguntas = [
    "¿Qué tipo de apego es el más dañino?",
    "¿Qué factores promueven el apego seguro?",
  ];
  
  let correcta = [3, 4];
  
  let opciones = [
    ["Apego seguro", "Apego inseguro ambivalente", "Apego inseguro evitativo","Apego desorganizado", "Ninguna de las Anteriores"],
    ["Apego en túnel", "Método Canguro", "Lactancia Materna","Porteo Seguro","Todas las Anteriores"],
  ];
