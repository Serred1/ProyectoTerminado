let preguntas = [
  "En relación a las Caries, marque la alternativa FALSA",
    ];
    
    let correcta = [0];
    
    let opciones = [
      ["Es una enfermedad contagiosa de origen bacteriano",
  
       "Es una enfermedad crónica de origen multifactorial",
    
       "Es una enfermedad azúcar dependiente",
        
       "Es una enfermedad que se controla cambiando hábitos"],
    ];
